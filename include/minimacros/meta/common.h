...
#define EM_STR(...) DETAIL_M_STR(__VA_ARGS__)
#define DETAIL_M_STR(...) #__VA_ARGS__

// Concatenates N tokens.
#define EM_CAT(x, y) DETAIL_M_CAT(x, y)
#define EM_CAT3(x, y, z) DETAIL_M_CAT3(x, y, z)
#define EM_CAT4(x, y, z, w) DETAIL_M_CAT4(x, y, z, w)
...
#define EM_END(...) DETAIL_M_END(__VA_ARGS__)
