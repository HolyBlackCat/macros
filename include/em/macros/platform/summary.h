...
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "?? (" EM_STR(EM_CPP_STANDARD_DATE) ")" // Too new.
#elif EM_CPP_STANDARD == 26
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "26"
#elif EM_CPP_STANDARD > 23
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "26 (preview)"
#elif EM_CPP_STANDARD == 23
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "23"
#elif EM_CPP_STANDARD > 20
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "23 (preview)"
#elif EM_CPP_STANDARD == 20
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "20"
#elif EM_CPP_STANDARD > 17
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "20 (preview)"
#elif EM_CPP_STANDARD == 17
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "17"
#elif EM_CPP_STANDARD > 14
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "17 (preview)"
#elif EM_CPP_STANDARD == 14
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "14"
#elif EM_CPP_STANDARD > 11
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "14 (preview)"
#elif EM_CPP_STANDARD == 11
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "11"
#elif EM_CPP_STANDARD > 98
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "11 (preview)"
#elif EM_CPP_STANDARD == 98
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "98"
#else
#define DETAIL_EM_PLATFORM_SUMMARY_CPP "?? (" EM_STR(EM_CPP_STANDARD_DATE) ")" // Too old?
#endif
