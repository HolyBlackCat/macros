...
#define DETAIL_M_PLATFORM_SUMMARY_COMPILER_VERSION " " EM_STRING_COMPILER_VERSION
#else
#define DETAIL_M_PLATFORM_SUMMARY_COMPILER_VERSION
#endif

#if EM_CPP_STDLIB_VERSION
#define DETAIL_M_PLATFORM_SUMMARY_CPP_STDLIB_VERSION " " EM_STRING_CPP_STDLIB_VERSION
#else
...
#else
#define DETAIL_M_PLATFORM_SUMMARY_CPP "?? (" EM_STR(EM_CPP_STANDARD_DATE) ")"
#endif
