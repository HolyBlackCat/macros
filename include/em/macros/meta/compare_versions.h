...
#define EM_COMPARE_VERSION2(a, n, ...) DETAIL_M_COMPARE_VERSION2(__VA_ARGS__, DETAIL_M_COMPARE_VERSION2_2, DETAIL_M_COMPARE_VERSION2_1, x)(a, n, __VA_ARGS__)
#define EM_COMPARE_VERSION3(a, b, n, ...) DETAIL_M_COMPARE_VERSION3(__VA_ARGS__, DETAIL_M_COMPARE_VERSION3_3, DETAIL_M_COMPARE_VERSION3_2, DETAIL_M_COMPARE_VERSION3_1, x)(a, b, n, __VA_ARGS__)
#else
#define EM_COMPARE_VERSION2(a, n, ...) DETAIL_M_COMPARE_VERSION2 DETAIL_M_COMPARE_VERSION_DEFER(__VA_ARGS__, DETAIL_M_COMPARE_VERSION2_2, DETAIL_M_COMPARE_VERSION2_1, x)(a, n, __VA_ARGS__)
#define EM_COMPARE_VERSION3(a, b, n, ...) DETAIL_M_COMPARE_VERSION3 DETAIL_M_COMPARE_VERSION_DEFER(__VA_ARGS__, DETAIL_M_COMPARE_VERSION3_3, DETAIL_M_COMPARE_VERSION3_2, DETAIL_M_COMPARE_VERSION3_1, x)(a, b, n, __VA_ARGS__)
#define DETAIL_M_COMPARE_VERSION_DEFER
#endif
#define DETAIL_M_COMPARE_VERSION2(a, b, c, ...) c
#define DETAIL_M_COMPARE_VERSION2_1(a, n, x) ((n)/(a) EM_NONEMPTY_IDENTITY(x))
#define DETAIL_M_COMPARE_VERSION2_2(a, n, x, y) ((n) EM_NONEMPTY_IDENTITY(x)*(a)+(y))
#define DETAIL_M_COMPARE_VERSION3(a, b, c, d, ...) d
#define DETAIL_M_COMPARE_VERSION3_1(a, b, n, x) ((n)/(b)/(a) EM_NONEMPTY_IDENTITY(x))
#define DETAIL_M_COMPARE_VERSION3_2(a, b, n, x, y) ((n)/(b) EM_NONEMPTY_IDENTITY(x)*(a)+(y))
#define DETAIL_M_COMPARE_VERSION3_3(a, b, n, x, y, z) ((n) EM_NONEMPTY_IDENTITY(x)*(a)*(b)+(y)*(b)+(z))
