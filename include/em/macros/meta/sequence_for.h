// A foreach loop over `(a)(b)(c)` sequences, duplicated from here: https://github.com/HolyBlackCat/macro_sequence_for
// This file doesn't use the same naming convention as the rest of the repo.
